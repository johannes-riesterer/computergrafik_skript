...
\begin{align}
L_o(x, \omega_o) = L_e(x, \omega_o)  + \displaystyle \int_{\Omega} f_r (x, \omega_y, \omega_o) \cdot   L_o(y, \omega_x)  \cdot  G(x,y) \cdot   dA_y \; .
\end{align} 
...
\end{align}
führt. Multipliziert man beide Seiten mit $\phi_j$ und Integriert anschliessend beide Seiten über $F_j$  erhält man 
\begin{align}
B_j A_j    =  E_j A_j   +  \sum_i   \Biggl(  \displaystyle \int_{F_j}  f_j   \cdot \displaystyle \int_{F_i}   G(x,y) \cdot   dA_y \Biggr ) B_i  
\end{align}
