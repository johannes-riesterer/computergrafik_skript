...
\begin{figure}[H]\centering
    \subfloat[Raumwinkel]{
        \hspace*{0.05\textwidth}
         \includegraphics[width=0.5\textwidth]{images/solidangle.png}
    \label{fig:shadowmap3}
    }
    \hspace*{0.1\textwidth}
    \subfloat[Photometrisches Grundgesetz]{
    \includegraphics[width=0.5\textwidth]{images/Fotometrisches_Grundgesetz_Schema.png}
