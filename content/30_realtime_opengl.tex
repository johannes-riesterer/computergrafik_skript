...
\begin{figure}[H]
    ...
    \caption{Tiefeninformation von der Lichtquelle aus gerendert.} %TODO: fix caption&label
...
\begin{figure}[H]
    ...
    \caption{Szene normal gerendert.} %TODO: fix caption&label
...
\begin{figure}[H]
    ...
    \caption{Szene mit Schatten über das Shadow Map verfahren.} %TODO: fix caption&label
...
\begin{figure}[H]
    ...
    \caption{Szene grinder mit forward shading} %TODO: fix caption&label
    \label{fig:defferedshading}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Szene grinder mit  differed shading} %TODO: fix caption&label
    \label{fig:defferedshading}
\end{figure}
