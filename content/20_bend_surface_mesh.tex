...
% + Orientierung kann durch Konvention gespeichert werden
% - Nachbarschaftsbeziehungen nicht enthalten / schwierig zu berechnen
% - Welhe Ecke gehört zu welcher Kante?
% - Point in Mesh? (fast unmöglich zu berechnen)
\end{Definition}
...
% - Orientierung (schwierig zu speichern)
\end{Definition}
